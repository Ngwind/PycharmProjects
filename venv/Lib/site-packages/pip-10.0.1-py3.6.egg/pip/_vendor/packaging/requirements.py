...
class Requirement(object):
    ...
    # TODO: Can we test_package_a whether something is contained within a requirement?
    #       If so how do we do that? Do we need to test_package_a against the _name_ of
