...
with open("test_package_a.json", 'w+') as f:  # 打开json文件用于写入json数据
...
with open("test_package_a.json", 'r+') as f:  # 打开json文件
...
test = input("输入json数据：")
#test_package_a = '{"gameid":"1383532238264530","mno":"中国联通","devtype":"iPhone","screen":"375*667","appver":"0","nm":"0","cid":"0","os":"iOS","osid":"1","pt":"2","osver":"11.2.6","dev":"iPhone7,2","did":"3425F535-6F21-41CD-8321-97BF68909658","sdkver":"3.7.3.7","ip":"10.2.8.37","oid":"0","rectime":"1535357813","aid":"0"}'
